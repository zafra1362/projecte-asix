...
check_container "grafana" "$BASE_PATH/monitorizatge3000/contenidor-grafana.yml"
check_container "cadvisor" "$BASE_PATH/monitorizatge3000/contenidor-cadvisor.yml"
check_container "prometheus" "$BASE_PATH/monitorizatge3000/contenidor-prometheus.yml"
